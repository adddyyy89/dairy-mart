...
public class RetailerCreateOrderActivity extends AppCompatActivity {
    ...
    private void createOrder(List<SalesmanCreateOrderItem> orderPlaced) {
        ...
        try {
            ...
            for(SalesmanCreateOrderItem item : orderPlaced) {
                ...
                order.put("hsn", item.getProductHsn());
                order.put("unit", item.getQuantity());
                order.put("saleRate", item.getProductSaleRate());
                order.put("purchaseRate", item.getProductPurchaseRate());
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(RetailerCreateOrderActivity.this, "Order placed successfully.", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(RetailerCreateOrderActivity.this, SalesmanActivityOrdersActivity.class));
                    }
                },
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RetailerCreateOrderActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
    ...
    private void updateProductsList(String response) {
        ...
        try{
            ...
            Toast.makeText(RetailerCreateOrderActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }

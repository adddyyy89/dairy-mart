...
public class RetailerLedgerDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(RetailerLedgerDashboardActivity.this, RetailerDashboardActivity.class));
        ...
        nav_delivery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(RetailerLedgerDashboardActivity.this, RetailerDeliveryPendingActivity.class));
        ...
        nav_ledger.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(RetailerLedgerDashboardActivity.this, RetailerLedgerDashboardActivity.class));
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(RetailerLedgerDashboardActivity.this, response, Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RetailerLedgerDashboardActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override

...
public class SalesmanDeliveryDeliveredActivity extends AppCompatActivity {
    ...
    JSONObject deliveredDeliveries;


    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_salesman_delivery_delivered); // Create activity_welcome.xml
        ...
        nav_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesmanDeliveryDeliveredActivity.this, SalesmanDashboardActivity.class));
        ...
        nav_activity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesmanDeliveryDeliveredActivity.this, SalesmanActivityOrdersActivity.class));
        ...
        nav_delivery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesmanDeliveryDeliveredActivity.this, SalesmanDeliveryPendingActivity.class));
        ...
        nav_ledger.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesmanDeliveryDeliveredActivity.this, SalesmanLedgerDashboardActivity.class));
        ...
        deliveredTab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SalesmanDeliveryDeliveredActivity.this, SalesmanDeliveryDeliveredActivity.class));
            }
        });
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(SalesmanDeliveryDeliveredActivity.this, response, Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SalesmanDeliveryDeliveredActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override

...
public class SalesmanToRetailDao {
    ...
    public SalesmanToRetailDao(SalesmanToRetailDTO salesmanToRetailDTO) {
        this.retailerId = salesmanToRetailDTO.getRetailerId();
        this.lastUpdated = salesmanToRetailDTO.getLastUpdated();
        this.createdBy = salesmanToRetailDTO.getCreatedBy();
        this.createdOn = salesmanToRetailDTO.getCreatedOn();
        this.salesmanId = salesmanToRetailDTO.getSalesmanId();
        this.vehicleNumber = salesmanToRetailDTO.getVehicleNumber();
        this.branchId = salesmanToRetailDTO.getBranchId();
        this.isActive = salesmanToRetailDTO.isActive();
    }

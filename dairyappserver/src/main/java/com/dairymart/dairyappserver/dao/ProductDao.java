...
public class ProductDao {
    ...
    public ProductDao(ProductDTO dto) {
        this.setProductId(dto.getProductId());
        this.setActive(dto.getActive());
        this.setBrandId(dto.getBrandId());
        this.setHsn(dto.getHsn());
        this.setCreatedBy(dto.getCreatedBy());
        this.setCreatedon(dto.getCreatedon());
        this.setLastUpdated(dto.getLastUpdated());
        this.setProductName(dto.getProductName());
        this.setProductPictureUrl(dto.getProductPictureUrl());
        this.setProductPurchaseRate(dto.getProductPurchaseRate());
        this.setProductSaleRate(dto.getProductSaleRate());
        this.setProductShortName(dto.getProductShortName());
        this.setProductTypeId(dto.getProductTypeId());
        this.setMrp(dto.getMrp());
        this.setProductCode(dto.getProductCode());
        this.setQuantity(dto.getQuantity());
        this.setUnit(dto.getUnit());
        this.setIgst(dto.getIgst());
    }

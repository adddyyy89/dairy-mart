...
public class LedgerDao {
    ...
    public LedgerDao(LedgerDTO ledgerDTO) {
        this.createdBy = ledgerDTO.getCreatedBy();
        this.active = ledgerDTO.isActive();
        this.createdOn = ledgerDTO.getCreatedOn();
        this.lastUpdated = ledgerDTO.getLastUpdated();
        this.retailerId = ledgerDTO.getRetailerId();
        this.salesmanId = ledgerDTO.getSalesmanId();
    }

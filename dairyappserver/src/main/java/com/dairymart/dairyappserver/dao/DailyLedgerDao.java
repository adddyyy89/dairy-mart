...
import com.dairymart.dairyappserver.dto.DailyLedgerDTO;
...
public class DailyLedgerDao {
    ...
    public DailyLedgerDao(DailyLedgerDTO dto) {
        this.userId = dto.getUserId();
        this.recordTimestamp = dto.getRecordTimestamp();
        this.startingWalletBalance = dto.getStartingWalletBalance();
        this.startingOutstandingBalance = dto.getStartingOutstandingBalance();
        this.walletBalance = dto.getWalletBalance();
        this.outstandingBalance = dto.getOutstandingBalance();
        this.totalBalance = dto.getTotalBalance();
